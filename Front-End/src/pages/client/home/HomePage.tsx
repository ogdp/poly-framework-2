...
import { FindProductByPrice, SearchProductByName } from '../../../services/product';
  ...
  return (
    <section className="py-20 bg-gray-50 font-poppins dark:bg-gray-800 ">
      <div className="banner">
        <Carousel autoplay>
          <img src="https://theme.hstatic.net/1000376021/1000834008/14/slideshow_4.jpg?v=3691" alt="" />
          <img src="https://theme.hstatic.net/1000376021/1000834008/14/slideshow_5.jpg?v=3691" alt="" />
          <img src="https://theme.hstatic.net/1000376021/1000834008/14/slideshow_6.jpg?v=3691" alt="" />
