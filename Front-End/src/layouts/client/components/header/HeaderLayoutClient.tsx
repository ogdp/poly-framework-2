            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6">
                ...
                <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} sm:hidden mt-4 mx-auto`}>
                    ...
                    <div className="mt-4 ml-[-10px]">
                        <Link to="/signup" className="mx-2 px-2 py-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold rounded-md">Signup</Link>
                        <Link to="/signin" className="mx-2 px-2 py-2 bg-green-500 hover:bg-green-700 text-white font-semibold rounded-md">Signin</Link>
                        {/* Shopping cart icon */}
                        <Link to="/cart" className="mt-4 text-sm font-medium text-gray-700 hover:text-blue-400 flex items-center">
